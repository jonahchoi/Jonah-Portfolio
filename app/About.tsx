...
const About = () => {
  return (
    <section className='h-[75vh] md:h-screen flex justify-center items-center'>
      <div className='w-[90%] md:w-[75%] xl:w-[60%] grid grid-flow-row auto-rows-min md:grid-rows-none md:grid-cols-2 md:gap-5'>
        ...
        <div className='flex flex-col gap-5 justify-center items-center bg-white py-10 w-full xl:w-[80%] m-auto drop-shadow-md'>
