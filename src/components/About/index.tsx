    ...
    <section className="h-[75vh] md:h-screen mt-1 flex justify-center items-center">
      <div className="w-[90%] md:w-[75%] xl:w-[60%] h-full md:h-auto grid grid-flow-row auto-rows-min md:grid-rows-none md:grid-cols-2 md:gap-5">
        ...
        >
          ...
          <motion.p className="" variants={ChildrenVariant}>
            I&apos;m a Software Engineer specializing in web development. I
            strive to bring unique ideas to life. You can find me contemplating
            layouts and adjusting margins.
            <br />
            <br />
            In my free time, I love playing games, dancing, and spending time
